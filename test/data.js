...
const CLIENT_INTROSPECTION_AUTH_URL = `${CLIENT_INTROSPECTION_URL}/oauth/v2/introspection`;
...
module.exports = {
    ...
    CLIENT_INTROSPECTION_PORT,  CLIENT_INTROSPECTION_URL, CLIENT_INTROSPECTION_AUTH_URL
};